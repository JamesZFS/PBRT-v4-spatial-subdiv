...
void Application::SpatialSubdivisionSettings() {
    ...
    if (ImGui::CollapsingHeader("Spatial Subdivision")) {
        ...
        int minSamplesCanidateSplit = (int) m_subdivCfg.minSamplesCandidateSplit;
        ...
        ImGui::InputInt("Min Samples Candidate Split", &minSamplesCanidateSplit, 1000, 5000);
        ...
        m_subdivCfg.minSamplesCandidateSplit = std::max(0, minSamplesCanidateSplit);
